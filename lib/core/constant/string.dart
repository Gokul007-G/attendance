...
const String splashTitle = "Welcome to Attendance App";
...
const String loginSubTitle1 = "Please enter your Employee ID to access";
const String loginSubTitle2 = "your dashboard";
const String loginTextFieldTitel = "Employee ID/Login ID";
const String loginTextFieldHint = "e.g.1001";
...
//Login Screen Image
const String loginIcon = "assets/login/loginLogo.svg";
